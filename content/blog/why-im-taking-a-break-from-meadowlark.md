...
I want to explain in this blog why I'm putting Meadowlark and all its sub-projects in a temporary hiatus. And perhaps this article can be helpful for anyone else wanting to create a project of this scale.

In short, I've been feeling overwhelmed and depressed lately. You can probably see my frustrations start to pile up in my previous blog [DAW Frontend Development Struggles](../daw-frontend-development-struggles), but the issues go deeper than that.
...
But now I find that managing so many repositories is a headache. Every time I see an issue or a PR, I get anxious about having to now spend my time responding to it. It also seems to disrupt my flow for the rest of the day.
...
Another thing I could do is not worry about performance or looks at all for MVP and use something like [egui](https://github.com/emilk/egui). But we will still need to switch to a better GUI library at some point.
...
But even if I did have a sound architecture with lots of documentation, I'm still wary about relying on volunteer effort. For one it makes me anxious thinking about having to create, manage, and coordinate all of those tasks. And two, no offense to anyone wanting help, but there isn't much room for "good first issue" tasks in something as complex as a DAW, at least for the initial bulk development.

Most of the eager volunteers I get say they are new to Rust and/or they want to help as a way to learn how DSP or audio software works. Again I don't want to sound disrespectful (I was in the same boat myself at one point), but there's definitely some prerequisite knowledge required in making a complex DAW codebase. Do I just wait until enough volunteers learn Rust and/or DSP?

If I do decide to have a team of developers, I think it would be better to have only a few people (maybe even just one or two) who can dedicate their full time (or part time) to the project. But if I do go that route, I would have to go through the trouble of finding these people and possibly hiring them. Oh and not to mention actually raising the money to hire someone. (Kickstarter maybe?)
...
So I feel like if anyone in the world can make this project happen, it's me. I want to do something meaningful with all the things I've learned.

But do I want to become a project lead or even a CEO of a nonprofit to make that happen? I just don't know. I'm really questioning if I'm enough of a social-oriented person to do that or be happy doing that.
